...
class ExpressionTreePuzzle(Puzzle):
    ...
    def __str__(self) -> str:
        ...
        result += self._tree.__str__() + ' = {}'.format(self.target)
        return result
        ...
        for key in self.variables:
            if self.variables[key] == 0:
                ...
                while new_value < 10:
                    ...
                    new_puzzle = ExpressionTreePuzzle(
    ...
    def fail_fast(self) -> bool:
        ...
        if self._tree.eval(self.variables) < self.target\
                and len(self.extensions()) != 0 or self.is_solved():
            return False
        return True
        # all_assigned = True
        # for key in self.variables:
        #     if self.variables[key] == 0:
        #         all_assigned = False
        # return all_assigned and self._tree.eval(self.variables) != self.target
