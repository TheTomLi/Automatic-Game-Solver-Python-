...
def test_sudoku_extensions() -> None:
    s = SudokuPuzzle(4, [["B", "D", "A", "C"],
                         ["C", "A", "B", "D"],
                         ["A", "B", " ", " "],
                         [" ", " ", " ", " "]],
                     {"A", "B", "C", "D"})
    lst_extensions = s.extensions()
    s1 = SudokuPuzzle(4, [["B", "D", "A", "C"],
                         ["C", "A", "B", "D"],
                         ["A", "B", "C", " "],
                         [" ", " ", " ", " "]],
                     {"A", "B", "C", "D"})
    s2 = SudokuPuzzle(4, [["B", "D", "A", "C"],
                         ["C", "A", "B", "D"],
                         ["A", "B", "D", " "],
                         [" ", " ", " ", " "]],
                     {"A", "B", "C", "D"})
    assert len(lst_extensions) == 2
    assert s1 in lst_extensions and s2 in lst_extensions
...
def test_has_unique_solution_2() -> None:
    s = SudokuPuzzle(4, [["D", "C", "B", "A"],
                         ["B", "A", "D", "C"],
                         ["C", "B", "A", " "],
                         ["A", "D", "C", " "]],
...
# def test_dfs_solver_example_2() -> None:
#     s = SudokuPuzzle(4, [[" ", " ", "B", " "],
#                          ["B", " ", "D", "C"],
#                          [" ", " ", "A", " "],
#                          [" ", " ", "C", " "]],
...
# def test_bfs_solver_example_2() -> None:
#     s1 = SudokuPuzzle(4, [[" ", " ", "B", " "],
#                           ["B", " ", "D", "C"],
#                           [" ", " ", "A", " "],
#                           [" ", " ", "C", " "]],
...
def test_expression_tree_eq_doctest() -> None:
    ...
    t3 = ExprTree('*', [ExprTree('+', [ExprTree(6, []), ExprTree(5, [])]),
                        ExprTree(1, [])])
    t4 = ExprTree('*', [ExprTree('+', [ExprTree(7, []), ExprTree(5, [])]),
                        ExprTree(1, [])])
    assert t3.__eq__(t4) is False
...
def test_expression_tree_puzzle_extension_advance() -> None:
    exp_t = ExprTree('+', [ExprTree('a', []), ExprTree('b', [])])
    puz = ExpressionTreePuzzle(exp_t, 8)
    puz.variables['a'] = 1
    exts_of_puz = puz.extensions()
    assert len(exts_of_puz) == 9
    assert exts_of_puz[0].variables['a'] == 1
    assert exts_of_puz[0].variables['b'] == 1
